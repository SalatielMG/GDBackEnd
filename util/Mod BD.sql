...
ALTER TABLE backup_accounts_duplicado ADD UNIQUE(id_backup, id_account, name, detail, sign, income, expense, initial_balance, final_balance, month, year, positive_limit, negative_limit, positive_max, negative_max, iso_code, selected, value_type, include_total, rate, icon_name);
...
ALTER TABLE backup_automatics_duplicado ADD UNIQUE(id_backup, id_operation, id_account,id_category,period,repeat_number,each_number,enabled,amount,sign,detail,initial_date,next_date,operation_code,rate,counter);
...
ALTER TABLE backup_budgets_duplicado ADD UNIQUE(id_backup,id_account,id_category,period,amount,budget,initial_date,final_date,number);
...
ALTER TABLE backup_cardviews_duplicado ADD UNIQUE(id_backup,id_card,name,period,sign,show_card,number);
...
ALTER TABLE backup_categories_duplicado ADD UNIQUE(id_backup, id_category, id_account, name, sign, icon_name, number);
...
ALTER TABLE backup_currencies_duplicado ADD UNIQUE(id_backup,iso_code,symbol,icon_name,selected);
...
ALTER TABLE backup_extras_duplicado ADD UNIQUE(id_backup, id_extra, account, category);
...
ALTER TABLE backup_movements_duplicado ADD UNIQUE(id_backup, id_account, id_category, amount, sign, detail, date_record, time_record, confirmed, transfer, date_idx, day, week, fortnight, month, year, operation_code, picture, iso_code);
...
ALTER TABLE backup_preferences_duplicado ADD UNIQUE(id_backup, key_name, value);
